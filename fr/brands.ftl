...
-brand-name-firefox-browser = { "{" } $capitalization ->    [uppercase] Navigateur Firefox    *[lowercase] navigateur Firefox{ "}" }
-brand-name-firefox-browsers = { "{" } $capitalization ->    [uppercase] Navigateurs Firefox    *[lowercase] navigateurs Firefox{ "}" }
