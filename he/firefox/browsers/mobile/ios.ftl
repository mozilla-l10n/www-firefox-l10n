...
mobile-ios-open-a-new = פתחו לשוניות חדשה ב־{ -brand-name-firefox } כדי לראות את האתרים שבהם אתם מבקרים בתדירות הגבוהה ביותר, את הסימניות האחרונות שלכם ואת המאמרים הפופולריים ב־{ -brand-name-pocket }. ‏{ -brand-name-firefox } מעניק לך גישה מהירה לאתרים שבהם השתמשתם לאחרונה כדי לעזור לכם להגיע ליעד שלכם מהר יותר.
