...
browsers-chromebook-while-a-chromebook = בעוד שב־{ -brand-name-chromebook } כבר מותקן { -brand-name-chrome }, הורדה ושימוש ב־{ -brand-name-firefox } כדפדפן העיקרי שלכם מספקים לך מספר יתרונות:
browsers-chromebook-alwayson-tracking-protection = הגנה מפני מעקב מופעלת תמיד: כברירת מחדל, { -brand-name-firefox } מריץ הגנת מעקב מתקדמת (ETP) כדי להגן על הנתונים האישיים שלכם מפני רכיבי מעקב מוכרים של פרסומות, רכיבי מעקב של רשתות חברתיות ותסריטי כריית מטבעות העוקבים אחריכם ברשת.
